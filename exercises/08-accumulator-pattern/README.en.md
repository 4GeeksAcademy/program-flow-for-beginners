# `08` Accumulator Pattern

Scenario: Shopping cart total. Read item prices repeatedly, accumulate total, and when user stops, show total and end.
...
## :bulb: Hint
- Your graph should include these key concepts: start, input, loop, output, end.
