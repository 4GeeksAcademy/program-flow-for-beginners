...
Escenario: Total de carrito de compras. Lee precios repetidamente, acumula total y cuando el usuario termine, muestra total y finaliza.
...
## :bulb: Pista
- Tu grafo debe incluir estos conceptos clave: inicio (start), entrada (input), bucle (loop), salida (output), fin (end).
