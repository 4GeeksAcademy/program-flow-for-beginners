...
Car rental. A person can rent only if they are 21+ and have a valid driver license. If they fail any condition, they cannot rent and finish through the rejection path. Model nested decisions and final outcomes.
