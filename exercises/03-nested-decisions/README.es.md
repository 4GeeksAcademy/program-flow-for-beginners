...
Escenario: Alquiler de auto. Una persona solo puede alquilar si tiene 21+ y licencia de conducir valida. Modela decisiones anidadas y resultados finales.
...
## :bulb: Pista
- Tu grafo debe incluir estos conceptos clave: inicio (start), entrada (input), valido (valid), casa (home), fin (end).
