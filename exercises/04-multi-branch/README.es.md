...
Escenario: Control de semaforo. Segun el color (verde, amarillo, rojo), elige la accion correspondiente y luego continua.
...
## :bulb: Pista
- Tu grafo debe incluir estos conceptos clave: inicio (start), entrada (input), casa (home), salida (output), fin (end).
